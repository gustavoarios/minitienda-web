    ...
    <footer className="main-footer">
      <div className="main-footer-container">
        ...
        {/* <div className="footer-newsletter-section">
          <h3 className="footer-newsletter-title">Suscríbete a nuestro newsletter</h3>
        ...
        <div className="main-footer-content">
          ...
          <div className="footer-brand-section">
            ...
            {/* <p>
              Especialistas en formación empresarial y consultoría. 
              Transformamos tu negocio con conocimiento práctico y estrategias efectivas.
            </p>
          ...
          <div className="footer-categories-section">
            ...
            <ul className="footer-categories-list">
              <li><a href="/services">Consultoría Empresarial</a></li>
              <li><a href="/services">Formación Corporativa</a></li>
              <li><a href="/services">Desarrollo Organizacional</a></li>
              <li><a href="/services">Coaching Ejecutivo</a></li>
              <li><a href="/services">Auditorías de Procesos</a></li>
            </ul>
          </div>
          ...
          <div className="footer-connect-section">
            ...
            <p className="footer-connect-description">
              Unite a nuestra comunidad y mantenete actualizado con las últimas tendencias en comunicación.
            </p>
            <div className="footer-social-links">
        ...
        <div className="footer-bottom">
          ...
          <div>
            <a href="/privacy" className="footer-privacy-link">Política de Privacidad</a>
            {' | '}
            <a href="/terms" className="footer-privacy-link">Términos de Uso</a>
          </div>
        </div>
      </div>
    </footer>
